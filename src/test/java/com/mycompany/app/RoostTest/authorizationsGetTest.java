    ...
    public void authorizations_get_Test() {  
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/com/mycompany/app/RoostTest/authorizationsGetTest.csv"))) {  
            ...
            if (response.jsonPath().get("authorizations[`"+ i +"`].name") != null) {  
                MatcherAssert.assertThat(response.jsonPath().getString("authorizations[`"+ i +"`].name"), CoreMatchers.matchesPattern(^[\p{L} .'-]{1,100}$)); 
            ...
            if (response.jsonPath().get("authorizations[`"+ i +"`].email") != null) {  
                MatcherAssert.assertThat(response.jsonPath().getString("authorizations[`"+ i +"`].email"), CoreMatchers.matchesPattern(^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$)); 

                MatcherAssert.assertThat(response.jsonPath().get("authorizations[`"+ i +"`].email"), instanceOf(String.class));
                MatcherAssert.assertThat(response.jsonPath().getString("authorizations[`"+ i +"`].email"),/^[^s@]+@[^s@]+.[^s@]+$/.test(

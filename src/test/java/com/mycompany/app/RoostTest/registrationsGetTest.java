    ...
    public void registrations_get_Test() {  
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src/test/java/com/mycompany/app/RoostTest/registrationsGetTest.csv"))) {  
            ...
            if (response.jsonPath().get("registrations[`"+ i +"`].credentialUrl") != null) {  
                MatcherAssert.assertThat(response.jsonPath().getString("registrations[`"+ i +"`].credentialUrl"), CoreMatchers.matchesPattern(^\w+:(\/?\/?)[^\s]+$)); 
            ...
            if (response.jsonPath().get("registrations[`"+ i +"`].recipient.name") != null) {  
                MatcherAssert.assertThat(response.jsonPath().getString("registrations[`"+ i +"`].recipient.name"), CoreMatchers.matchesPattern(^[\p{L} .'-]{1,100}$)); 
